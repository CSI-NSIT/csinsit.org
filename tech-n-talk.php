...
<!--<script src="http://csinsit.org/js/snowstorm.js"></script>-->    <meta name="description" content="Do you want to make a website of your own? Here is a small help from our side for making you skilled enough for achieving that goal."> 
    ...
    <title>CSI NSIT Tech-n-Talk</title> 
...
<i class="fa fa-angle-double-up" style="font-size:40px; color:black"></i></a>
    ...
    <div class="container" style="padding-top:70px;"> 
        <div class="row pages-header">tech 'n' talk</div> 
        <div class="row col-md-10 col-md-offset-1 pages-header-descp">
            A major chunk of the inevitable guidance that we require is given by our seniors-an experienced intellectual lot, who take us through the journey by sharing their own experiences. CSI NSIT in its Tech and Talk invites distinguished guests-pass outs, alumni or seniors who have made a mark for themselves, to deliver some pearls of wisdom on what actually has to be done, apart from the regular course studies, especially in the tech sphere. It is a must attend informal seminar, where in the audience can ask the speakers anything and everything as to how they could make it to the pinnacle, and motivate themselves for the same. A platform to clear all queries, doubts and qualms, a budding tech enthusiast is often flooded with. 
        </div>
    </div>
	</main>
	<!--
