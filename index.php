    ...
    <body>
				...
				<div class="row mar-bot40">
					<div class="col-md-6 col-md-offset-3">
						...
						<div class="align-center">
							...
							<h2 class="slogan">Welcome to CSI NSIT</h2>
		...
		<div class="container"> 
			...
			<div class="row mar-bot40">
				<div class="col-lg-4" >
					<div class="align-center">
					    <a href="tech-n-talk.php">
					    <img src="img/tech-n-talk.jpg"/>
					    <br/><br/>
				...
				<div class="col-lg-4" >
					<div class="align-center">
					    <a href="bits-n-bytes.php">
					    <img src="img/bits-n-bytes.jpg"/>
					    <br/><br/>
...
<div class="container"> 
			...
			<div class="row mar-bot40">
				...
				<div class="col-lg-4" >
					<div class="align-center">
					    <a href="http://www.techelon.csinsit.org/">
					    <img src="img/techelon.jpg"/>
					    <br/><br/>
						<!--<i class="fa fa-bolt fa-5x mar-bot20"></i>-->
		...
		<section id="parallax1" class="section pad-top40 pad-bot40" data-stellar-background-ratio="0.5">
			<div class="container">
            <div class="align-center pad-top60 pad-bot20">
<!--                <div class="container">
-->
    ...
    <div id="myCarousel" class="carousel slide" data-interval="3000" data-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="item active">
                  ...
                  <h3  style="font-weight:500;color:#4d4d4d">Any sufficiently advanced technology is indistinguishable from magic. 
                  <br/>-Arthur C. Clarke
                  </h3>
            ...
            <div class="item">
                    ...
                    <h3 style="font-weight:500;color:#4d4d4d" >Innovation distinguishes between a leader and a follower.
                    <br/>-Steve Jobs
                    </h3>
            ...
            <div class="item">
                    ...
                    <h3 style="font-weight:500;color:#4d4d4d">Technology has to be invented or adopted. 
                    <br/>-Jared Diamond
                    </h3>
...
<br/><br/>
		...
		<section id="section-about" class="section appear clearfix"  style="background:#e6e6e6">
		<div class="container">

				<div class="row mar-bot40">
					<div class="col-md-offset-3 col-md-6">
						<div class="section-header">
							<h2 class="section-heading animated" data-animation="bounceInUp">Newsfeed</h2>
						</div>
					</div>
				</div>
	...
	<section id="footer" class="section footer">
		<div class="container">
			...
			<div class="row align-center copyright">
					<div class="col-sm-12"><p>CSI NSIT </p></div>
                    <!-- 
